...
<template>
  ...
  <header>
    <div class="fixed md:absolute z-30 w-full">
      <nav class="container h-30 flex items-center justify-between px-5 py-3 bg-transparent relative text-white"
        ...
        <a href="./" class="w-1/3 max-w-[60px]">
          <img src="@/assets/img/logo-tolko.svg" alt="Logo tolko" width="60" height="60" fetchpriority="high"
            class="w-full" />
        </a>
        <div class="flex items-center justify-end gap-2">
          ...
          <div
            ...
            <ul
              ...
              <li>
                <a href="#about" @click="scrollToSection(1); cerrarMenu()">{{ $t('menu.about_us') }}</a>
              </li>
              <li>
                <a href="#services" @click="scrollToSection(2); cerrarMenu()">{{ $t('menu.our_services') }}</a>
              </li>
              <li>
                <a href="#" @click="scrollToSection(3); cerrarMenu()">{{ $t('menu.join_our_team') }}</a>
              </li>
              <li>
                <a href="#contact" class="btn btn-red text-white" @click="scrollToSection(4); cerrarMenu()">{{
      ...
      <p class="container md:text-4xl pt-4 text-center max-w-5xl" data-aos="fade-up">
        {{ $t('section2.We_help_you_through') }} <br /><span
          class="font-SemiBoldItalic text-tolko-red text-3xl md:text-5xl">{{
            $t('section2.full_360_communication_support') }}</span><br />
        {{ $t('section2.in_one_team') }}
      </p>
      <div class="container grid grid-cols-1 gap-5 justify-items-center items-center py-12 md:grid-cols-2 lg:w-[60%]"
        data-aos="fade-up">
        <div
    ...
    <div
      ...
      <div class="text-center md:mx-0 md:text-left">
        ...
        <div class="mt-4">
          <span class="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
            <a class="text-gray-500 cursor-pointer hover:text-gray-700" href="https://www.facebook.com/tolkogroup/"
              alt="Facebook" aria-label="Facebook" target="_blank">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5"
                viewBox="0 0 24 24">
                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
              </svg>
            </a>
            <a class="ml-3 text-gray-500 cursor-pointer hover:text-gray-700" href="https://twitter.com/tolkogroup"
              alt="Twitter" aria-label="Twitter" target="_blank">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5"
                viewBox="0 0 24 24">
                <path
            ...
            <a class="ml-3 text-gray-500 cursor-pointer hover:text-gray-700"
              href="https://www.instagram.com/grupo_tolko" alt="Instagram" aria-label="Instagram" target="_blank">
            ...
            <a class="ml-3 text-gray-500 cursor-pointer hover:text-gray-700"
              href="https://www.linkedin.com/company/tolko/" alt="Linkedin" aria-label="Linkedin" target="_blank">
      ...
      <div class="text-center md:text-left">
        ...
        <nav class="mb-10 list-none">
          <ul>
            <li class="mt-3">
              <a class="text-gray-500 cursor-pointer hover:text-gray-200">
                <span class="text-white">{{ $t('footer.list2.item2') }}</span><br />
                {{ $t('footer.list2.item2_1') }}
              </a>
              <br />
              <a class="text-gray-500 cursor-pointer hover:text-gray-200"
                href="mailto:tolko360@tolkogroup.com">tolko360@tolkogroup.com</a>
              <br />
              <a class="text-gray-500 cursor-pointer hover:text-gray-200" href="https://tolkoproducciones.com/"
                target="_blank">tolkoproducciones.com</a>
            </li>
            <li class="mt-3">
              <a class="text-gray-500 cursor-pointer hover:text-gray-200">
                <span class="text-white">{{ $t('footer.list2.item3') }}</span><br />
      ...
      <div class="text-center md:text-left">
        ...
        <nav class="mb-10 list-none">
          <ul>
            <li class="mt-3">
              <a href="mailto:tolko360@tolkogroup.com" class="text-gray-500 cursor-pointer hover:text-gray-200">
