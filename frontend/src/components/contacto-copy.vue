...
<template>
  <section id="section4" class="container py-12 text-black">
    <div class="md:w-2/3 md:mx-auto">
      ...
      <FormKit type="form" id="frmContacto" :actions="false" @submit="onSubmit">
        <div class="grid md:grid-cols-2 grid-cols-1 gap-6">
          <FormKit v-model.trim="nombre" type="text" id="nombre" name="nombre"
            :placeholder="$t('section5.form.placeholderName')" validation="required" :validationMessages="{
              required: $t('section5.form.requiredName'),
            }" />
          <FormKit v-model.trim="telefono" type="text" id="telefono" name="telefono"
            :placeholder="$t('section5.form.placeholderTelephone')" validation="required" :validationMessages="{
              required: $t('section5.form.requiredTelephone'),
            }" />
          <div class="md:col-span-2">
            <FormKit v-model.trim="email" type="email" id="email" name="email"
              :placeholder="$t('section5.form.placeholderEmail')" validation="required|email" :validationMessages="{
          ...
          <div class="md:col-span-2">
            <FormKit v-model.trim="mensaje" name="mensaje" type="textarea" rows="5" cols=""
